                ...
                @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="no_telp" class="block mt-1 w-full" type="number" name="no_telp"
                                :value="old('no_telp')" required autocomplete="username" placeholder="Nomor Telepon" />
                        ...
                        <button type="submit"
                            class="w-full text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Create
                            an account</button>
                        <p class="flex items-center justify-center font-light text-gray-500 dark:text-gray-400">
                            Sudah punya akun ? <a href="{{ route('admin.login') }}"
                                class="ml-2 font-medium text-green-600 hover:underline dark:text-green-500">Login
                                disini</a>
                        </p>
                    </form>
                </div>
